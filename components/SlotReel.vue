<template>
  <div class="Reel" v-bind:class="{'is-locked':locked}" v-on:mousedown="lock()">
    <div class="Reel-inner">
      <img class="Reel-image py-5" :src="reelTileData[tile1Index].image" />
      <img class="Reel-image py-5" :src="reelTileData[tile2Index].image" />
      <img class="Reel-image py-5" :src="reelTileData[tile3Index].image" />
      <img class="Reel-image py-5" :src="reelTileData[tile4Index].image" />
      <img class="Reel-image py-5" :src="reelTileData[tile5Index].image" />
    </div>
  </div> 
</template>
      ...
      reelSourceData: [
        {
          name: 'Casque',
          value: 2,
          image: require("@/assets/img/casque.png")
        },
        {
          name: 'Phone',
          value: 10,
        ...
        },
        {
          name: 'Manette',
          value: 5,
          image: require("@/assets/img/manette.png")
        }
      ],
      reelIndex: 2,
      tile1Index: 0,
